...
# floor now sits at 0% so nothing real is clipped into the under-color. Since
# PlaHab resubmitted Case 11 at the protocol 900 W/m2 (2026-09-22; the first
# run was at 400 W/m2 and gave 63.7%), every sample lies inside the range, the
# highest being ROCKE-3D Case 7 at 44.3%.
...
plahab  = np.array( [ 19.11, runaway, runaway, 33.03, 33.02, runaway, 34.90, 29.62, 30.82, 0.89, 23.80, 35.51, 34.85, 31.12, 19.93, 35.54 ] )
...
def flag_degenerate( ax, structure, xv, yv, n ):
    ...
    ax.text( 0.5, 0.06, f'these {n} cases resolve no spatial structure', transform=ax.transAxes,
             ha='center', va='bottom', fontsize=9, style='italic', color='0.15',
