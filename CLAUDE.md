...
analysis/      # Scripts behind numbers quoted in the manuscript that no figure script
               # prints (sample-point ranges, spread medians, regime statistics, data
               # audits); README.md maps each to the text. Run from analysis/.
data/
